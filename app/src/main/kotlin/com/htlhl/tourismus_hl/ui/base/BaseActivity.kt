...
import com.htlhl.tourismus_hl.TourismusHLApp
import com.htlhl.tourismus_hl.injection.components.ActivityComponent
import com.htlhl.tourismus_hl.injection.components.DaggerActivityComponent
...
abstract class BaseActivity<B : ViewDataBinding, VM : MvvmViewModel<*>> : AppCompatActivity(), MvvmView {
    ...
    internal val activityComponent: ActivityComponent by lazy {
        DaggerActivityComponent.builder()
                ...
                .appComponent(TourismusHLApp.appComponent)
                .build()
    }
