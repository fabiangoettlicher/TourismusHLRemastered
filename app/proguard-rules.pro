...
#-keep class com.htlhl.tourismus_hl.** { *; }
#-dontwarn com.htlhl.tourismus_hl.**

# Keep component classes and inject methods
-keep class com.htlhl.tourismus_hl.injection.components.** {
    public void inject(...);
}

# Keep model classes
-keep class com.htlhl.tourismus_hl.data.model.** { *; }
